...
describe('job controller and worker thread API', () => {
  ...
  it('POST /api/projects/:projectId/jobs/zip - should start background compression', async () => {
  ...
  it('GET /api/projects/:projectId/jobs/:jobId - should poll until worker thread completes compression', async () => {
